...
import AddCompaniesDocuments from '../../pages/companies/addCompanies/AddCompaniesDocuments';
    ...
    const customIcons = (
        <React.Fragment>
            <div style={{ marginRight: "35%" }}>
                ...
                {sidebarToBeRender === "addClientInAddContract" && <h4>Create Client </h4>}
            ...
            <div style={{width:"130px"}}>
                ...
                {sidebarToBeRender === "addClientInAddContract" && companyNextLabels(value)}
                {sidebarToBeRender === "addTimesheet" && timesheetNextLabels(value)}
                {sidebarToBeRender === "addVendorInAddResource" && companyNextLabels(value)}
            </div>
    ...
    return (
        <div className="flex justify-content-center custom-scrollbar">
            ...
            >
                ...
                {sidebarToBeRender === "addNewResource" && <AddNewResource setValue={setValue} setProgress={setProgress} />}
                {sidebarToBeRender === "newContract" && <AddNewContract setProgress={setProgress} setValue={setValue} />}
                {/* {sidebarToBeRender === "addCompany" && <AddCompany setVisible={setVisible} setProgress={setProgress} setValue={setValue} addCompanyStepsView="companies" />} */}
                {sidebarToBeRender === "addVendorInAddResource" && <AddCompany setVisible={setVisible} setProgress={setProgress} setValue={setValue} addCompanyStepsView="companies" />}
                {sidebarToBeRender === "addClientInAddContract" && <AddCompany setVisible={setVisible} setProgress={setProgress} setValue={setValue} addCompanyStepsView="companies" />}
                {sidebarToBeRender === "addResource" && <AddResource />}
                {sidebarToBeRender === "addTimesheet" && <AddTimesheet setProgress={setProgress} setValue={setValue} />}
                {/* </ScrollPanel> */}
            </Sidebar>

            {sidebarToBeRender === "addNewResource" && <img src={plusIcon} className='cursorPointer' onClick={() => setVisible(true)} />}
            {sidebarToBeRender === "newContract" && <img src={plusIcon} className='cursorPointer' onClick={() => setVisible(true)} />}
            {sidebarToBeRender === "addCompany" && <img src={plusIcon} className='cursorPointer' onClick={() => setVisible(true)} />}
            {sidebarToBeRender === "addTimesheet" && <img src={plusIcon} className='cursorPointer' onClick={() => setVisible(true)} />}
            {/* {sidebarToBeRender === "addCompany" && <span className='pe-2 l-color-orange l-fw-500 cursorPointer' onClick={() => setVisible(true)}>+ ADD VENDOR</span>} */}
            {sidebarToBeRender === "addVendorInAddResource" && <span className='pe-2 l-color-orange l-fw-500 cursorPointer' onClick={() => setVisible(true)}>+ ADD VENDOR</span>}
            {sidebarToBeRender === "addClientInAddContract" && <span className='pe-2 l-color-orange l-fw-500 cursorPointer' onClick={() => setVisible(true)}>+ ADD</span>}
